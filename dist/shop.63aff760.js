...
_jquery(document).ready(function() {
    _jquery('.spoiler_title').click(function(event) {
        if (_jquery('.spoiler_container').hasClass('one')) {
            _jquery('.spoiler_title').not(_jquery(this)).removeClass('active');
            _jquery('.spoiler_text').not(_jquery(this).next()).slideUp(300);
        }
        _jquery(this).toggleClass('active').next().slideToggle(300);
    });
});
//Меню бургер
_jquery(document).ready(function() {
    _jquery('.header_burger').click(function(event) {
        _jquery('.header_burger,.header_menu').toggleClass('active');
        _jquery('body').toggleClass('lock');
    });
    _jquery('.header_list').click(function(event) {
        _jquery('.header_burger,.header_menu').toggleClass('active');
        _jquery('body').toggleClass('lock');
    });
});
...
},{"./css/style.css":"fsqEO","jquery":"hgMhh"}],"fsqEO":[function() {},{}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}]},["kse37","adjPd"], "adjPd", "parcelRequirea4a0")

//# sourceMappingURL=shop.63aff760.js.map
